...
char device_id[] = 		"27f30c1e4c4248f2943c6cde15d2ffbf";
char device_token[] = 		"200cef3270234fbda0e013883e02602a";
...
void openFilter(void){
	...
	s5j_gpiowrite(cfgcon_l_dir_pin, 0);
...
void closeWindow(void){
	...
	s5j_gpiowrite(cfgcon_r_dir_pin, 0);
	s5j_gpiowrite(cfgcon_r_ena_pin, 1);
	s5j_gpiowrite(cfgcon_r_clk_pin, 0);
